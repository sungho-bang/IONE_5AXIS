...
{
    public abstract class FAStackModule : FAInlineModule
    {
        #region Sequences
        ...
        protected virtual bool IsTerminatedStack()
        {
            return false;
        }
        ...
        protected virtual void MakeLoop()
        {
            ...
            seq.AddStep("ConfirmTerminatedStack").StepIndex = seq.AddItem(ConfirmTerminatedStack);
        ...
        private void ConfirmTerminatedStack(FASequence actor, TimeSpan time)
        {
            if (IsTerminatedStack())
                actor.NextStep();
            else
