...
{
    public class FADeviceIPCRemotingServer : FADeviceRemoting
    {
        ...
        public FADeviceIPCRemotingServer()
        {
            Timeout = 50;
        }
        ...
        {
            IpcChannel channel =
                new IpcChannel(string.Format("localhost:{0}", Port));
            ...
            string url = string.Format("ipc://localhost:{0}/RemoteObject.rem", Port);
